    ...
    <section>
      <div className="bg-gray-800 py-24 md:py-32">
        <div className="mx-auto max-w-5xl px-6">
          <div className="bg-gray-900 relative mx-auto w-fit">
            <div
              role="presentation"
              className="bg-radial absolute inset-0 z-10 from-transparent to-75%"
            />
          ...
          <div className="mx-auto mt-6 max-w-lg space-y-6 text-center">
            <h2 className="text-balance text-gray-400 text-3xl font-semibold md:text-4xl">
              a place of
            </h2>
